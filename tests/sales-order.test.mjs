...
import {initial,seedAccounts,command,today} from '../src/invoice-engine.js';
...
test('the invoice inherits the order scope and the customer receivable ledger',()=>{
 ...
 const {order}=saveSalesOrder([],{...data,organizationId:'abc',organizationName:'Wayvida',branchId:'abc-kochi',branchName:'Kochi Branch',receivableAccount:'1100'},state.config,'Confirmed');
 ...
 assert.equal(invoice.organizationName,'Wayvida');
