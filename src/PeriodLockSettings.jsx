...
export default function PeriodLockSettings({settings,onClose=()=>{},onSaved=()=>{},notify=()=>{},organisations=demoOrganizations}){
 ...
 return <div className="pls pls-popup">
  <header className="pls-heading pls-heading-popup"><div><h1>Period Lock Settings</h1><p>Locking applies to every module in Wayvida Books, and changes apply from the next unclosed period.</p></div><button type="button" className="pls-close" onClick={requestClose} aria-label="Close period closing settings"><IconX size={17}/></button></header>
