...
export const initialPeriods=[
 {id:'2026-04-kochi',companyId:'ABC01',scopeType:'Branches',branchIds:['abc-kochi'],year:'2026-27',name:'April 2026',start:'2026-04-01',end:'2026-04-30',status:'Locked',lockType:'Hard Lock',closedBy:'Finance Manager',lockedBy:'Finance Manager',closedAt:'2026-04-30T18:00:00',lockedAt:'2026-04-30T18:00:00',reason:'Closing'},
 {id:'2026-05-kochi',companyId:'ABC01',scopeType:'Branches',branchIds:['abc-kochi'],year:'2026-27',name:'May 2026',start:'2026-05-01',end:'2026-05-31',status:'Locked',lockType:'Hard Lock',closedBy:'Finance Manager',lockedBy:'Finance Manager',closedAt:'2026-05-31T18:00:00',lockedAt:'2026-05-31T18:00:00',reason:'Closing'},
 {id:'2026-06-kochi',companyId:'ABC01',scopeType:'Branches',branchIds:['abc-kochi'],year:'2026-27',name:'June 2026',start:'2026-06-01',end:'2026-06-30',status:'Locked',lockType:'Hard Lock',closedBy:'Finance Manager',lockedBy:'Finance Manager',closedAt:'2026-06-30T18:00:00',lockedAt:'2026-06-30T18:00:00',reason:'Closing'},
 {id:'2026-07-koz',companyId:'ABC01',scopeType:'Branches',branchIds:['abc-bengaluru'],year:'2026-27',name:'July 2026',start:'2026-07-01',end:'2026-07-31',status:'Locked',lockType:'Hard Lock',closedBy:'Finance Manager',lockedBy:'Finance Manager',closedAt:'2026-07-31T18:00:00',lockedAt:'2026-07-31T18:00:00',reason:'Closing'},
 {id:'2026-08-koz',companyId:'ABC01',scopeType:'Branches',branchIds:['abc-bengaluru'],year:'2026-27',name:'August 2026',start:'2026-08-01',end:'2026-08-31',status:'Locked',lockType:'Hard Lock',closedBy:'Admin',lockedBy:'Admin',closedAt:'2026-08-31T18:00:00',lockedAt:'2026-08-31T18:00:00',reason:'Closing'},
 {id:'2026-09-kochi',companyId:'ABC01',scopeType:'Branches',branchIds:['abc-kochi'],year:'2026-27',name:'September 2026',start:'2026-09-01',end:'2026-09-30',status:'Open',lockType:'�',closedBy:'',lockedBy:'',closedAt:'',lockedAt:'',reason:''},
 {id:'2026-09-koz',companyId:'ABC01',scopeType:'Branches',branchIds:['abc-bengaluru'],year:'2026-27',name:'September 2026',start:'2026-09-01',end:'2026-09-30',status:'Open',lockType:'�',closedBy:'',lockedBy:'',closedAt:'',lockedAt:'',reason:''},
 {id:'2026-09-blr',companyId:'NSR02',scopeType:'Branches',branchIds:['northstar-chennai'],year:'2026-27',name:'September 2026',start:'2026-09-01',end:'2026-09-30',status:'Open',lockType:'�',closedBy:'',lockedBy:'',closedAt:'',lockedAt:'',reason:''}
];
...
const PERIOD_ORGANISATIONS={ABC01:'Wayvida Learning',NSR02:'Viskool'};
const PERIOD_BRANCHES={'abc-trivandrum':'Trivandrum Branch','abc-kochi':'Kochi Branch','abc-bengaluru':'Bengaluru Branch','northstar-chennai':'Trivandrum Branch','northstar-coimbatore':'Thrissur Branch'};
...
const initialRequests = [
 {id:'ULR-0001',periodId:'2026-08-kochi',period:'August 2026',companyId:'ABC01',organisationName:'Wayvida Learning',scopeType:'Branches',branchIds:['abc-kochi'],requestedBy:'Accountant',reason:'Correct supplier invoice posted after period close',status:'Approved',date:'2026-09-02T10:15:00'},
 {id:'ULR-0002',periodId:'2026-07-koz',period:'July 2026',companyId:'ABC01',organisationName:'Wayvida Learning',scopeType:'Branches',branchIds:['abc-bengaluru'],requestedBy:'Accountant',reason:'Customer payment needs correction',status:'Approved',date:'2026-08-04T14:30:00'},
 {id:'ULR-0003',periodId:'2026-08-koz',period:'August 2026',companyId:'ABC01',organisationName:'Wayvida Learning',scopeType:'Branches',branchIds:['abc-bengaluru'],requestedBy:'Finance Manager',reason:'Inventory adjustment required',status:'Rejected',date:'2026-09-05T11:20:00'},
 {id:'ULR-0004',periodId:'2026-08-kochi',period:'August 2026',companyId:'ABC01',organisationName:'Wayvida Learning',scopeType:'Branches',branchIds:['abc-kochi'],requestedBy:'Accountant',reason:'GST adjustment required',status:'Pending approval',date:'2026-09-07T09:45:00'},
 {id:'ULR-0005',periodId:'2026-09-koz',period:'September 2026',companyId:'ABC01',organisationName:'Wayvida Learning',scopeType:'Branches',branchIds:['abc-bengaluru'],requestedBy:'Accountant',reason:'Incorrect journal entry',status:'Pending approval',date:'2026-09-18T15:10:00'},
 {id:'ULR-0006',periodId:'2026-06-blr',period:'June 2026',companyId:'NSR02',organisationName:'Viskool',scopeType:'Branches',branchIds:['northstar-chennai'],requestedBy:'Finance Manager',reason:'Audit correction',status:'Approved',date:'2026-07-12T16:20:00'}
];
export const emptyPeriodControl=()=>({version:1,periods:structuredClone(initialPeriods),requests:structuredClone(initialRequests),audit:[]});
const browserStorage=()=>typeof localStorage==='undefined'?null:localStorage;
export function readPeriodControl(store=browserStorage()){try{let state=JSON.parse(store?.getItem(PERIOD_STORAGE))||emptyPeriodControl(),settings=readPeriodSettings(store);if(!settings.automaticPeriodCreation)return state;let created=0;for(const organisation of [{companyId:'ABC01',organisationName:'Wayvida'},{companyId:'NSR02',organisationName:'Viskool'}]){const generated=generateFinancialYearPeriods(state,{financialYearStart:'2026-04-01',financialYearEnd:'2027-03-31',...organisation});state=generated.state;created+=generated.created.length}if(created)store?.setItem(PERIOD_STORAGE,JSON.stringify(state));return state}catch{return emptyPeriodControl()}}
...
export function createLockWindow(state,{frequency,date,preview=false,companyId='ABC01',organisationName='Wayvida Learning',scopeType='Organisation',branchIds=[],branchNames=[],availableBranchIds,financialYearId}){
